...
const routes = [
  ...
  { path: '/tüketim-veri-girisi', name: 'Tüketim Veri Girişi', element: ConsumptionInputPage },
  {path: '/elektrik', name: 'Elektrik', element: Electiricty},
  {path: '/elektrik-tuketim-ai', name: 'Elektrik Tüketim AI', element: ElectricityConsumptionAI},
  {path: '/dogalgaz-tuketim', name: 'Doğalgaz Tüketim', element: NaturalGasConsumption},  
  {path: '/su-tuketim', name: 'Su Tüketim', element: WaterConsumption},
  {path: '/kagit-tuketim', name: 'Kağıt Tüketim', element: PaperConsumption},
  {path: '/karbon-ayakizi', name: 'Karbon Ayakizi', element: EmissionDataPage},
  {path: '/okul-bilgi-formu', name: 'Okul Bilgi Formu', element: SchoolInfoForm},
  {path: '/anomalies', name: 'Anomalies', element: AnomaliesDetectionPage},
  {path: '/tahmin-sonuc', name: 'Tahmin Sonuc', element: PredictionResult},
  {path: '/kayıt-silme', name: 'Kayıt Silme', element: DeleteRecordPage},
  ...
  ...(isAdmin
    ? [{ path: '/kulanicilar-olustur', name: 'User Management', element: UserCreatePage }]
    : []),
]
